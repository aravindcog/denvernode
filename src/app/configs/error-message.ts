...
export class ErrorMessageService {
  ...
  manageCommittee = {
    searchCommittee: `${this.static_data.manage_committee.search_committees} Required`,
    committeeType: `${this.static_data.manage_committee.committee_type} Required`,
    committeeStatus: `${this.static_data.manage_committee.committee_status} Required`,
    startDate: `${this.static_data.manage_committee.start_date} Required`,
    endDate: `${this.static_data.manage_committee.end_date} Required`,
    officer: `${this.static_data.manage_committee.office} Required`,
    publicFundStatus: `${this.static_data.manage_committee.public_funding_status} Required`,
  };
  ief = {
  ...
  checkErrorMessage(formType: any, type: string) {
    switch (type) {
      ...
      case "searchCommittee":
        return formType.hasError("required")
          ? this.manageCommittee.searchCommittee
          : "";
      case "committeeType":
        return formType.hasError("required")
          ? this.manageCommittee.committeeType
          : "";
      case "committeeStatus":
        return formType.hasError("required")
          ? this.manageCommittee.committeeStatus
          : "";
      case "startDate":
        return formType.hasError("required")
          ? this.manageCommittee.startDate
          : "";
      case "endDate":
        return formType.hasError("required")
          ? this.manageCommittee.endDate
          : "";
      case "office":
        return formType.hasError("required")
          ? this.manageCommittee.officer
          : "";
      case "publicFundingStatus":
        return formType.hasError("required")
          ? this.manageCommittee.publicFundStatus
          : "";
      case "issueNumber":
        return formType.hasError("required")
