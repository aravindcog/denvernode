...
@NgModule({
  declarations: [ManagementComponent, UserPermissionComponent, BallotMeasuresComponent, CommiteeTypeComponent, OfficesComponent, ContributionLimitsComponent, MatchingLimitComponent],
  imports: [
    CommonModule,
