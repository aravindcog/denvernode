...
@NgModule({
  declarations: [ManageCommitteesComponent, ExistingCommitteeInfoComponent, PublicFundingComponent,ManageCommitteesComponent, NewCommitteeApproveDenyComponent],
  imports: [
    CommonModule,
